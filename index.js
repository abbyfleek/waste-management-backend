...
// Middleware
app.use(cors({
    origin: ['http://localhost:3000', 'https://waste-management-backend-16f60d04g-abbyfleeks-projects.vercel.app'],
...
process.env.FRONTEND_URL = 'https://waste-management-backend-16f60d04g-abbyfleeks-projects.vercel.app';
...
app.get('/api/confirm-email', async (req, res) => {
    try {
        ...
        res.redirect(`${process.env.FRONTEND_URL || 'https://waste-management-backend-16f60d04g-abbyfleeks-projects.vercel.app'}/login?message=Email confirmed successfully! You can now login.`);
    } catch (error) {
        console.error('Email confirmation error:', error);
...
app.post('/api/reset-password', async (req, res) => {
    try {
        ...
        const { data, error } = await supabase.auth.resetPasswordForEmail(email, {
            redirectTo: `${process.env.FRONTEND_URL || 'https://waste-management-backend-16f60d04g-abbyfleeks-projects.vercel.app'}/reset-password`
        });
...
app.post('/api/save-qr', async (req, res) => {
    try {
        ...
        // Generate QR URL
        const baseUrl = process.env.FRONTEND_URL || 'https://waste-management-backend-16f60d04g-abbyfleeks-projects.vercel.app';
